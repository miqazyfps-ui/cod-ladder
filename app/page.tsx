...
export default function Home() {
  ...
  function BadgeSVG({ level, size = 40 }: { level: number, size?: number }) {
    ...
    const shapes: any = {
      BRONZE: (
        <svg viewBox="0 0 140 155" width={size} height={size}>
          <polygon points="70,6 128,38 128,102 70,134 12,102 12,38" fill="#1c0e04" stroke="#cd7f32" stroke-width="3.5"/>
          <polygon points="70,14 120,42 120,98 70,126 20,98 20,42" fill="#120a04" stroke="#cd7f32" stroke-width="1.5"/>
          <line x1="12" y1="38" x2="128" y2="38" stroke="#e8a050" stroke-width="1.5" opacity="0.5"/>
          <line x1="12" y1="102" x2="128" y2="102" stroke="#7a4a1a" stroke-width="1.5" opacity="0.4"/>
          <polygon points="70,30 84,54 70,78 56,54" fill="#cd7f32" opacity="0.9"/>
          <polygon points="70,26 87,52 83,76 57,76 53,52" fill="none" stroke="#e8a050" stroke-width="2.5"/>
          <line x1="70" y1="30" x2="84" y2="54" stroke="#f0b060" stroke-width="0.8" opacity="0.5"/>
          <line x1="70" y1="30" x2="56" y2="54" stroke="#f0b060" stroke-width="0.8" opacity="0.5"/>
          <circle cx="70" cy="6" r="5" fill="#e8a050"/>
          <circle cx="128" cy="38" r="4" fill="#cd7f32"/><circle cx="12" cy="38" r="4" fill="#cd7f32"/>
          <circle cx="70" cy="134" r="5" fill="#cd7f32"/>
          <text x="70" y="112" textAnchor="middle" fontFamily="Impact" fontSize="9" fill="#e8a050" letterSpacing="2">BRONZE</text>
        </svg>
      ),
      ARGENT: (
        <svg viewBox="0 0 140 155" width={size} height={size}>
          <polygon points="70,6 128,38 128,102 70,134 12,102 12,38" fill="#0a0a12" stroke="#94a3b8" stroke-width="3.5"/>
          <polygon points="70,14 120,42 120,98 70,126 20,98 20,42" fill="#06060e" stroke="#94a3b8" stroke-width="1.5"/>
          <line x1="12" y1="38" x2="128" y2="38" stroke="#e2e8f0" stroke-width="1.5" opacity="0.4"/>
          <rect x="38" y="32" width="64" height="64" rx="6" fill="#0d0d18" stroke="#94a3b8" stroke-width="2"/>
          <circle cx="70" cy="64" r="14" fill="#0a0a12" stroke="#e2e8f0" stroke-width="2"/>
          <circle cx="70" cy="64" r="5" fill="#94a3b8" opacity="0.9"/>
          <circle cx="70" cy="64" r="2" fill="#f1f5f9"/>
          <circle cx="70" cy="6" r="5" fill="#e2e8f0"/>
          <circle cx="128" cy="38" r="4" fill="#94a3b8"/><circle cx="12" cy="38" r="4" fill="#94a3b8"/>
          <text x="70" y="112" textAnchor="middle" fontFamily="Impact" fontSize="9" fill="#e2e8f0" letterSpacing="2">ARGENT</text>
        </svg>
      ),
      OR: (
        <svg viewBox="0 0 140 155" width={size} height={size}>
          <polygon points="70,6 128,38 128,102 70,134 12,102 12,38" fill="#1a1400" stroke="#ffd700" stroke-width="4"/>
          <polygon points="70,14 120,42 120,98 70,126 20,98 20,42" fill="#100e00" stroke="#ffd700" stroke-width="2"/>
          <line x1="12" y1="38" x2="128" y2="38" stroke="#fff8a0" stroke-width="2" opacity="0.5"/>
          <polygon points="70,28 74,42 88,42 77,51 81,66 70,57 59,66 63,51 52,42 66,42" fill="#ffd700"/>
          <polygon points="70,32 73,43 84,43 75,50 78,61 70,55 62,61 65,50 56,43 67,43" fill="#1a1400"/>
          <circle cx="70" cy="52" r="5" fill="#ffd700"/>
          <circle cx="70" cy="52" r="2" fill="#fff8b0"/>
          <circle cx="70" cy="6" r="6" fill="#fff8a0"/>
          <circle cx="128" cy="38" r="5" fill="#ffd700"/><circle cx="12" cy="38" r="5" fill="#ffd700"/>
          <text x="70" y="108" textAnchor="middle" fontFamily="Impact" fontSize="13" fill="#fff8a0" letterSpacing="5">OR</text>
        </svg>
      ),
      PLATINE: (
        <svg viewBox="0 0 140 155" width={size} height={size}>
          <polygon points="70,6 128,38 128,102 70,134 12,102 12,38" fill="#00050f" stroke="#7dd3fc" stroke-width="4"/>
          <polygon points="70,14 120,42 120,98 70,126 20,98 20,42" fill="#00020a" stroke="#7dd3fc" stroke-width="2"/>
          <line x1="12" y1="38" x2="128" y2="38" stroke="#e0f2fe" stroke-width="2" opacity="0.5"/>
          <circle cx="70" cy="64" r="26" fill="#00080f" stroke="#7dd3fc" stroke-width="2.5"/>
          <circle cx="70" cy="64" r="20" fill="#000508" stroke="#bae6fd" stroke-width="1.5"/>
          <polygon points="70,40 77,55 94,55 80,65 85,82 70,71 55,82 60,65 46,55 63,55" fill="#7dd3fc" opacity="0.9"/>
          <polygon points="70,46 76,57 89,57 79,64 83,77 70,68 57,77 61,64 51,57 64,57" fill="#00080f"/>
          <circle cx="70" cy="64" r="5" fill="#7dd3fc" opacity="0.85"/>
          <circle cx="70" cy="64" r="2" fill="#e0f2fe"/>
          <circle cx="70" cy="6" r="5" fill="#e0f2fe"/>
          <text x="70" y="116" textAnchor="middle" fontFamily="Impact" fontSize="9" fill="#e0f2fe" letterSpacing="1">PLATINE</text>
        </svg>
      ),
      DIAMANT: (
        <svg viewBox="0 0 140 155" width={size} height={size}>
          <polygon points="70,6 128,38 128,102 70,134 12,102 12,38" fill="#000514" stroke="#3b82f6" stroke-width="4"/>
          <polygon points="70,14 120,42 120,98 70,126 20,98 20,42" fill="#00020a" stroke="#3b82f6" stroke-width="2"/>
          <line x1="12" y1="38" x2="128" y2="38" stroke="#bfdbfe" stroke-width="2" opacity="0.5"/>
          <polygon points="70,26 96,50 96,82 70,106 44,82 44,50" fill="#1e3a8a" opacity="0.3"/>
          <polygon points="70,26 96,50 96,82 70,106 44,82 44,50" fill="none" stroke="#3b82f6" stroke-width="3"/>
          <polygon points="70,34 88,54 88,78 70,98 52,78 52,54" fill="none" stroke="#93c5fd" stroke-width="2"/>
          <line x1="70" y1="26" x2="70" y2="106" stroke="#3b82f6" stroke-width="1.5" opacity="0.5"/>
          <line x1="44" y1="66" x2="96" y2="66" stroke="#3b82f6" stroke-width="1.5" opacity="0.5"/>
          <circle cx="70" cy="66" r="7" fill="#1e3a8a" stroke="#3b82f6" stroke-width="2"/>
          <circle cx="70" cy="66" r="3" fill="#bfdbfe"/>
          <circle cx="70" cy="6" r="6" fill="#bfdbfe"/>
          <text x="70" y="122" textAnchor="middle" fontFamily="Impact" fontSize="9" fill="#bfdbfe" letterSpacing="1">DIAMANT</text>
        </svg>
      ),
      MAITRE: (
        <svg viewBox="0 0 140 155" width={size} height={size}>
          <polygon points="70,6 128,38 128,102 70,134 12,102 12,38" fill="#001a00" stroke="#00ff88" stroke-width="4"/>
          <polygon points="70,14 120,42 120,98 70,126 20,98 20,42" fill="#000f00" stroke="#00ff88" stroke-width="2"/>
          <line x1="12" y1="38" x2="128" y2="38" stroke="#ccffdd" stroke-width="2" opacity="0.5"/>
          <path d="M70,22 L76,34 L70,28 L64,34 Z" fill="#00ff88"/>
          <path d="M64,34 L70,28 L76,34 L74,48 L70,56 L66,48 Z" fill="#00cc66"/>
          <path d="M66,48 L70,56 L74,48 L78,62 L70,74 L62,62 Z" fill="#009944" opacity="0.95"/>
          <path d="M62,62 L70,74 L78,62 L80,78 L70,88 L60,78 Z" fill="#006622" opacity="0.9"/>
          <path d="M70,28 L70,88" stroke="#66ffaa" stroke-width="2.5" opacity="0.5"/>
          <path d="M62,36 L70,32 L78,36" fill="none" stroke="#ccffdd" stroke-width="2" opacity="0.7"/>
          <path d="M61,48 L70,44 L79,48" fill="none" stroke="#aaffcc" stroke-width="1.5" opacity="0.6"/>
          <path d="M60,60 L70,56 L80,60" fill="none" stroke="#88ffbb" stroke-width="1.5" opacity="0.5"/>
          <circle cx="70" cy="6" r="6" fill="#ccffdd"/>
          <text x="70" y="114" textAnchor="middle" fontFamily="Impact" fontSize="9" fill="#ccffdd" letterSpacing="2">MAITRE</text>
        </svg>
      ),
      LEGENDAIRE: (
        <svg viewBox="0 0 140 155" width={size} height={size}>
          <polygon points="70,6 128,38 128,102 70,134 12,102 12,38" fill="#0d0014" stroke="#a855f7" stroke-width="4.5"/>
          <polygon points="70,14 120,42 120,98 70,126 20,98 20,42" fill="#080008" stroke="#a855f7" stroke-width="2"/>
          <line x1="12" y1="38" x2="128" y2="38" stroke="#ffd700" stroke-width="2" opacity="0.5"/>
          <rect x="36" y="72" width="68" height="24" rx="4" fill="#2d0050" stroke="#a855f7" stroke-width="2"/>
          <rect x="40" y="64" width="10" height="14" rx="2" fill="#2d0050" stroke="#a855f7" stroke-width="1.5"/>
          <rect x="65" y="58" width="10" height="20" rx="2" fill="#2d0050" stroke="#ffd700" stroke-width="2"/>
          <rect x="90" y="64" width="10" height="14" rx="2" fill="#2d0050" stroke="#a855f7" stroke-width="1.5"/>
          <circle cx="45" cy="62" r="5" fill="#ffd700"/>
          <circle cx="70" cy="56" r="6" fill="#ffd700"/>
          <circle cx="95" cy="62" r="5" fill="#ffd700"/>
          <polygon points="36,48 48,36 70,30 92,36 104,48 100,62 70,68 40,62" fill="none" stroke="#a855f7" stroke-width="2.5"/>
          <polygon points="42,50 52,40 70,34 88,40 98,50 95,61 70,65 45,61" fill="none" stroke="#ffd700" stroke-width="1.5"/>
          <circle cx="70" cy="49" r="9" fill="#0d0014" stroke="#a855f7" stroke-width="2.5"/>
          <circle cx="70" cy="49" r="5" fill="#a855f7" opacity="0.9"/>
          <circle cx="70" cy="49" r="2" fill="#ffd700"/>
          <rect x="55" y="2" width="30" height="10" rx="2" fill="#0d0014" stroke="#ffd700" stroke-width="1.5"/>
          <rect x="59" y="0" width="5" height="6" rx="1" fill="#ffd700"/>
          <rect x="68" y="0" width="5" height="7" rx="1" fill="#ffd700"/>
          <rect x="77" y="0" width="5" height="6" rx="1" fill="#ffd700"/>
          <circle cx="128" cy="38" r="5" fill="#ffd700"/><circle cx="12" cy="38" r="5" fill="#ffd700"/>
          <text x="70" y="120" textAnchor="middle" fontFamily="Impact" fontSize="8" fill="#ffd700" letterSpacing="0.5">LEGENDAIRE</text>
        </svg>
      ),
    };
    ...
    <div style={{ background: dark, minHeight: '100vh', fontFamily: 'Segoe UI, sans-serif', color: light }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px' }}>
        ...
        {activeTab === 'accueil' && (
          <>
            {/* HERO FULL */}
            <div style={{ position: 'relative', height: '500px', borderRadius: '16px', overflow: 'hidden', marginBottom: '24px' }}>
              <img src="/images/hero_home.png" alt="Clutch2Win" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 20%' }} />
              <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.5) 60%, rgba(0,0,0,0.3) 100%)' }} />
              <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column' as const, justifyContent: 'center', alignItems: 'flex-start', padding: '0 60px' }}>
                <div style={{ fontSize: '10px', fontWeight: 700, letterSpacing: '4px', color: gold, textTransform: 'uppercase' as const, marginBottom: '16px', border: `1px solid ${gold}`, padding: '4px 12px', borderRadius: '20px' }}>
                  Plateforme Esport
                </div>
                <div style={{ fontSize: '64px', fontWeight: 900, color: '#fff', lineHeight: 1, marginBottom: '8px' }}>
                  CLUTCH
                </div>
                <div style={{ fontSize: '64px', fontWeight: 900, color: gold, lineHeight: 1, marginBottom: '20px' }}>
                  2WIN
                </div>
                <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.55)', marginBottom: '32px', maxWidth: '420px', lineHeight: 1.6 }}>
                  Affronte les meilleurs joueurs en 1v1 jusqu&apos;au 6v6 &middot; Call of Duty &middot; FC 26
                </p>
                <div style={{ display: 'flex', gap: '12px' }}>
                  <button onClick={() => user ? setActiveTab('jeux') : setShowAuth(true)} style={{ background: gold, color: dark, border: 'none', padding: '14px 32px', borderRadius: '8px', fontWeight: 800, fontSize: '14px', cursor: 'pointer', textTransform: 'uppercase' as const, letterSpacing: '1px' }}>
                    {user ? 'Jouer' : 'Commencer gratuitement'}
                  </button>
                  <button onClick={() => setActiveTab('classement')} style={{ background: 'transparent', color: 'rgba(255,255,255,0.7)', border: '1px solid rgba(255,255,255,0.25)', padding: '14px 28px', borderRadius: '8px', fontWeight: 600, fontSize: '14px', cursor: 'pointer' }}>
                    Classement
                  </button>
                </div>
              </div>
              ...
              <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(10px)', padding: '16px 40px', display: 'flex', gap: '40px' }}>
                {[
                  { label: 'Joueurs', value: String(leaderboard.length), icon: '👥' },
                  { label: 'Matchs en direct', value: String(liveMatches.length), icon: '🔴' },
                  { label: 'Matchs joués', value: String(matches.length), icon: '⚔️' },
                  { label: 'Jeux disponibles', value: '2', icon: '🎮' },
                ].map((s, i) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <span style={{ fontSize: '20px' }}>{s.icon}</span>
                    <div>
                      <div style={{ fontSize: '20px', fontWeight: 900, color: gold, lineHeight: 1 }}>{s.value}</div>
                      <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase' as const, letterSpacing: '1px' }}>{s.label}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div style={{ marginBottom: '24px' }}>
              <div style={{ fontSize: '10px', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase' as const, color: muted, marginBottom: '14px' }}>Top joueurs</div>
              {leaderboard.length === 0 ? (
                <div style={{ background: card, border: `1px solid ${border}`, borderRadius: '12px', padding: '40px', textAlign: 'center', color: muted, fontSize: '14px' }}>
                  Aucun joueur class&eacute; — Sois le premier !
                </div>
              ) : (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
                  {leaderboard.slice(0, 3).map((p, i) => (
                    <div key={i} style={{ background: card, border: `1px solid ${i === 0 ? gold : border}`, borderRadius: '12px', padding: '24px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                      ...
                      <div style={{ fontSize: '24px', marginBottom: '10px' }}>{i === 0 ? '🥇' : i === 1 ? '🥈' : '🥉'}</div>
                      <div style={{ width: '54px', height: '54px', borderRadius: '50%', background: goldBg, border: `2px solid ${i === 0 ? gold : border}`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', fontWeight: 900, color: gold, margin: '0 auto 12px', overflow: 'hidden' }}>
                        {p.avatar_url ? <img src={p.avatar_url} style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : p.username?.[0]?.toUpperCase()}
                      </div>
                      <div style={{ fontSize: '15px', fontWeight: 800, color: light, marginBottom: '6px' }}>{p.username}</div>
