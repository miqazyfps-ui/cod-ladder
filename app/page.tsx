...
export default function Home() {
  ...
  function BadgeSVG({ level, size = 40 }: { level: number, size?: number }) {
    ...
    const shapes: Record<string, JSX.Element> = {
      BRONZE: <svg viewBox='0 0 140 155' width={size} height={size}><polygon points='70,6 128,38 128,102 70,134 12,102 12,38' fill='#1c0e04' stroke='#cd7f32' strokeWidth='3.5'/><polygon points='70,14 120,42 120,98 70,126 20,98 20,42' fill='#120a04' stroke='#cd7f32' strokeWidth='1.5'/><line x1='12' y1='38' x2='128' y2='38' stroke='#e8a050' strokeWidth='1.5' opacity='0.5'/><polygon points='70,30 84,54 70,78 56,54' fill='#cd7f32' opacity='0.9'/><polygon points='70,26 87,52 83,76 57,76 53,52' fill='none' stroke='#e8a050' strokeWidth='2.5'/><circle cx='70' cy='6' r='5' fill='#e8a050'/><circle cx='128' cy='38' r='4' fill='#cd7f32'/><circle cx='12' cy='38' r='4' fill='#cd7f32'/><circle cx='70' cy='134' r='5' fill='#cd7f32'/><text x='70' y='112' textAnchor='middle' fontFamily='Impact' fontSize='9' fill='#e8a050' letterSpacing='2'>BRONZE</text></svg>,
      ARGENT: <svg viewBox='0 0 140 155' width={size} height={size}><polygon points='70,6 128,38 128,102 70,134 12,102 12,38' fill='#0a0a12' stroke='#94a3b8' strokeWidth='3.5'/><polygon points='70,14 120,42 120,98 70,126 20,98 20,42' fill='#06060e' stroke='#94a3b8' strokeWidth='1.5'/><line x1='12' y1='38' x2='128' y2='38' stroke='#e2e8f0' strokeWidth='1.5' opacity='0.4'/><rect x='38' y='32' width='64' height='64' rx='6' fill='#0d0d18' stroke='#94a3b8' strokeWidth='2'/><circle cx='70' cy='64' r='14' fill='#0a0a12' stroke='#e2e8f0' strokeWidth='2'/><circle cx='70' cy='64' r='5' fill='#94a3b8' opacity='0.9'/><circle cx='70' cy='64' r='2' fill='#f1f5f9'/><circle cx='70' cy='6' r='5' fill='#e2e8f0'/><circle cx='128' cy='38' r='4' fill='#94a3b8'/><circle cx='12' cy='38' r='4' fill='#94a3b8'/><text x='70' y='112' textAnchor='middle' fontFamily='Impact' fontSize='9' fill='#e2e8f0' letterSpacing='2'>ARGENT</text></svg>,
      OR: <svg viewBox='0 0 140 155' width={size} height={size}><polygon points='70,6 128,38 128,102 70,134 12,102 12,38' fill='#1a1400' stroke='#ffd700' strokeWidth='4'/><polygon points='70,14 120,42 120,98 70,126 20,98 20,42' fill='#100e00' stroke='#ffd700' strokeWidth='2'/><line x1='12' y1='38' x2='128' y2='38' stroke='#fff8a0' strokeWidth='2' opacity='0.5'/><polygon points='70,28 74,42 88,42 77,51 81,66 70,57 59,66 63,51 52,42 66,42' fill='#ffd700'/><polygon points='70,32 73,43 84,43 75,50 78,61 70,55 62,61 65,50 56,43 67,43' fill='#1a1400'/><circle cx='70' cy='52' r='5' fill='#ffd700'/><circle cx='70' cy='52' r='2' fill='#fff8b0'/><circle cx='70' cy='6' r='6' fill='#fff8a0'/><circle cx='128' cy='38' r='5' fill='#ffd700'/><circle cx='12' cy='38' r='5' fill='#ffd700'/><text x='70' y='108' textAnchor='middle' fontFamily='Impact' fontSize='13' fill='#fff8a0' letterSpacing='5'>OR</text></svg>,
      PLATINE: <svg viewBox='0 0 140 155' width={size} height={size}><polygon points='70,6 128,38 128,102 70,134 12,102 12,38' fill='#00050f' stroke='#7dd3fc' strokeWidth='4'/><polygon points='70,14 120,42 120,98 70,126 20,98 20,42' fill='#00020a' stroke='#7dd3fc' strokeWidth='2'/><line x1='12' y1='38' x2='128' y2='38' stroke='#e0f2fe' strokeWidth='2' opacity='0.5'/><circle cx='70' cy='64' r='26' fill='#00080f' stroke='#7dd3fc' strokeWidth='2.5'/><circle cx='70' cy='64' r='20' fill='#000508' stroke='#bae6fd' strokeWidth='1.5'/><polygon points='70,40 77,55 94,55 80,65 85,82 70,71 55,82 60,65 46,55 63,55' fill='#7dd3fc' opacity='0.9'/><polygon points='70,46 76,57 89,57 79,64 83,77 70,68 57,77 61,64 51,57 64,57' fill='#00080f'/><circle cx='70' cy='64' r='5' fill='#7dd3fc' opacity='0.85'/><circle cx='70' cy='64' r='2' fill='#e0f2fe'/><circle cx='70' cy='6' r='5' fill='#e0f2fe'/><text x='70' y='116' textAnchor='middle' fontFamily='Impact' fontSize='9' fill='#e0f2fe' letterSpacing='1'>PLATINE</text></svg>,
      DIAMANT: <svg viewBox='0 0 140 155' width={size} height={size}><polygon points='70,6 128,38 128,102 70,134 12,102 12,38' fill='#000514' stroke='#3b82f6' strokeWidth='4'/><polygon points='70,14 120,42 120,98 70,126 20,98 20,42' fill='#00020a' stroke='#3b82f6' strokeWidth='2'/><line x1='12' y1='38' x2='128' y2='38' stroke='#bfdbfe' strokeWidth='2' opacity='0.5'/><polygon points='70,26 96,50 96,82 70,106 44,82 44,50' fill='#1e3a8a' opacity='0.3'/><polygon points='70,26 96,50 96,82 70,106 44,82 44,50' fill='none' stroke='#3b82f6' strokeWidth='3'/><polygon points='70,34 88,54 88,78 70,98 52,78 52,54' fill='none' stroke='#93c5fd' strokeWidth='2'/><line x1='70' y1='26' x2='70' y2='106' stroke='#3b82f6' strokeWidth='1.5' opacity='0.5'/><line x1='44' y1='66' x2='96' y2='66' stroke='#3b82f6' strokeWidth='1.5' opacity='0.5'/><circle cx='70' cy='66' r='7' fill='#1e3a8a' stroke='#3b82f6' strokeWidth='2'/><circle cx='70' cy='66' r='3' fill='#bfdbfe'/><circle cx='70' cy='6' r='6' fill='#bfdbfe'/><text x='70' y='122' textAnchor='middle' fontFamily='Impact' fontSize='9' fill='#bfdbfe' letterSpacing='1'>DIAMANT</text></svg>,
      MAITRE: <svg viewBox='0 0 140 155' width={size} height={size}><polygon points='70,6 128,38 128,102 70,134 12,102 12,38' fill='#001a00' stroke='#00ff88' strokeWidth='4'/><polygon points='70,14 120,42 120,98 70,126 20,98 20,42' fill='#000f00' stroke='#00ff88' strokeWidth='2'/><line x1='12' y1='38' x2='128' y2='38' stroke='#ccffdd' strokeWidth='2' opacity='0.5'/><path d='M70,22 L76,34 L70,28 L64,34 Z' fill='#00ff88'/><path d='M64,34 L70,28 L76,34 L74,48 L70,56 L66,48 Z' fill='#00cc66'/><path d='M66,48 L70,56 L74,48 L78,62 L70,74 L62,62 Z' fill='#009944' opacity='0.95'/><path d='M62,62 L70,74 L78,62 L80,78 L70,88 L60,78 Z' fill='#006622' opacity='0.9'/><path d='M70,28 L70,88' stroke='#66ffaa' strokeWidth='2.5' opacity='0.5'/><path d='M62,36 L70,32 L78,36' fill='none' stroke='#ccffdd' strokeWidth='2' opacity='0.7'/><path d='M61,48 L70,44 L79,48' fill='none' stroke='#aaffcc' strokeWidth='1.5' opacity='0.6'/><path d='M60,60 L70,56 L80,60' fill='none' stroke='#88ffbb' strokeWidth='1.5' opacity='0.5'/><circle cx='70' cy='6' r='6' fill='#ccffdd'/><text x='70' y='114' textAnchor='middle' fontFamily='Impact' fontSize='9' fill='#ccffdd' letterSpacing='2'>MAITRE</text></svg>,
      LEGENDAIRE: <svg viewBox='0 0 140 155' width={size} height={size}><polygon points='70,6 128,38 128,102 70,134 12,102 12,38' fill='#0d0014' stroke='#a855f7' strokeWidth='4.5'/><polygon points='70,14 120,42 120,98 70,126 20,98 20,42' fill='#080008' stroke='#a855f7' strokeWidth='2'/><line x1='12' y1='38' x2='128' y2='38' stroke='#ffd700' strokeWidth='2' opacity='0.5'/><rect x='36' y='72' width='68' height='24' rx='4' fill='#2d0050' stroke='#a855f7' strokeWidth='2'/><rect x='40' y='64' width='10' height='14' rx='2' fill='#2d0050' stroke='#a855f7' strokeWidth='1.5'/><rect x='65' y='58' width='10' height='20' rx='2' fill='#2d0050' stroke='#ffd700' strokeWidth='2'/><rect x='90' y='64' width='10' height='14' rx='2' fill='#2d0050' stroke='#a855f7' strokeWidth='1.5'/><circle cx='45' cy='62' r='5' fill='#ffd700'/><circle cx='70' cy='56' r='6' fill='#ffd700'/><circle cx='95' cy='62' r='5' fill='#ffd700'/><polygon points='36,48 48,36 70,30 92,36 104,48 100,62 70,68 40,62' fill='none' stroke='#a855f7' strokeWidth='2.5'/><polygon points='42,50 52,40 70,34 88,40 98,50 95,61 70,65 45,61' fill='none' stroke='#ffd700' strokeWidth='1.5'/><circle cx='70' cy='49' r='9' fill='#0d0014' stroke='#a855f7' strokeWidth='2.5'/><circle cx='70' cy='49' r='5' fill='#a855f7' opacity='0.9'/><circle cx='70' cy='49' r='2' fill='#ffd700'/><rect x='55' y='2' width='30' height='10' rx='2' fill='#0d0014' stroke='#ffd700' strokeWidth='1.5'/><rect x='59' y='0' width='5' height='6' rx='1' fill='#ffd700'/><rect x='68' y='0' width='5' height='7' rx='1' fill='#ffd700'/><rect x='77' y='0' width='5' height='6' rx='1' fill='#ffd700'/><circle cx='128' cy='38' r='5' fill='#ffd700'/><circle cx='12' cy='38' r='5' fill='#ffd700'/><text x='70' y='120' textAnchor='middle' fontFamily='Impact' fontSize='8' fill='#ffd700' letterSpacing='0.5'>LEGENDAIRE</text></svg>,
    };
